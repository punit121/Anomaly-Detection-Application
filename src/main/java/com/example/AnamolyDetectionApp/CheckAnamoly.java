...
public class CheckAnamoly {
	...
	public int checkEqualityScore(String str1, List<String> s2) {
		int count = 0;
	...
	public int CheckAnamolyById(PostAd post1) throws FileNotFoundException{
       ...
       // String[] s2= data1.split(" ");
        ...
        int t  = checkEqualityScore(str1, anomaliesWordList);
